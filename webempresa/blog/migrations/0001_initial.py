# Generated by Django 2.0.2 on 2020-07-08 08:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('published', models.DateTimeField(default=datetime.datetime(2020, 7, 8, 8, 32, 4, 978226, tzinfo=utc), verbose_name='Fecha de publicación')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Fecha de creación')),
                ('updated', models.DateTimeField(auto_now_add=True, verbose_name='Fecha de modificación')),
